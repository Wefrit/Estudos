...
def higher_card(card_one, card_two):
    ...
    :return: str or tuple - the higher card, or both if equal.
    """
...
def value_of_ace(card_one, card_two):
    ...
    if card_one == 'A': 
        if value_of_two + 11 <= 10:
            return 11
        return 1
    if card_two == 'A':
        if value_of_one + 11 <= 10:
            return 11
        return 1
    if value_of_one + value_of_two + 11 <= 21:    
        return 11
    return 1
...
def can_split_pairs(card_one, card_two):
    ...
    return value_of_one == value_of_two
...
def can_double_down(card_one, card_two):
    ...
    return value_of_one + value_of_two in [9, 10, 11]
